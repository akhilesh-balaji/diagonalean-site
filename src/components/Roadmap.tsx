...
export default function Roadmap() {
  ...
  return (
    <section id="roadmap" className="w-full px-6 py-10 max-w-5xl mx-auto">
      ...
      {!loading && !error && (
        <div
          ...
          prose-a:text-primary prose-a:no-underline hover:prose-a:underline
          prose-code:text-secondary prose-code:bg-base-300 prose-code:px-1 prose-code:rounded
          prose-pre:bg-base-300/7! prose-pre:p-2! prose-pre:m-0! prose-pre:rounded-lg!
          prose-pre:text-lg prose-pre:border-base-300/25 prose-pre:border-2
          prose-strong:text-base-content
